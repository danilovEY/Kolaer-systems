package ru.kolaer.server.service.storage.service;
...
import ru.kolaer.server.service.storage.converter.UploadFileConverter;
import ru.kolaer.server.service.storage.dto.UploadFileDto;
...
import ru.kolaer.server.service.storage.repository.UploadFileRepository;
...
public class UploadFileServiceImpl
        extends AbstractDefaultService<UploadFileDto, UploadFileEntity, UploadFileRepository, UploadFileConverter>
        implements UploadFileService {
    private final SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd.MM.yyyy");
    private final Path rootLocation = Paths.get("upload");

    public UploadFileServiceImpl(UploadFileRepository uploadFileDao, UploadFileConverter uploadFileConverter) {
