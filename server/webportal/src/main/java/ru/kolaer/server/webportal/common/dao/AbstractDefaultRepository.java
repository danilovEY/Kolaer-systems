package ru.kolaer.server.webportal.common.dao;
 ...
 */
public abstract class AbstractDefaultRepository<T extends BaseEntity> implements DefaultRepository<T> {
    ...
    protected AbstractDefaultRepository(SessionFactory sessionFactory, Class<T> entityClass) {
