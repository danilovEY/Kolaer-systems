...
@Directive({
	...
	providers: [MdbBsDropdownState]
})
export class MdbBsDropdownDirective implements OnInit, OnDestroy {
	...
	_isInlineOpen = false;
	_showInline: boolean;
	_inlinedMenu: EmbeddedViewRef<MdbBsDropdownMenuDirective>;

	_isDisabled: boolean;
	_dropdown: ComponentLoader<MdbBsDropdownContainerComponent>;
	...
	constructor(private _elementRef: ElementRef,
				...
				private _cis: MdbComponentLoaderFactory,
				private _config: MdbBsDropdownConfig,
				private _state: MdbBsDropdownState) {
		// create dropdown component loader
		this._dropdown = this._cis
			.createLoader<MdbBsDropdownContainerComponent>(this._elementRef, this._viewContainerRef, this._renderer)
			.provide({provide: MdbBsDropdownState, useValue: this._state});
	...
	ngOnInit(): void {
		...
		if (this._showInline) {
			this._state.dropdownMenu
				.then((dropdownMenu: BsComponentRef<MdbBsDropdownMenuDirective>) => {
	...
	show(): void {
		...
		this._state.dropdownMenu
			.then((dropdownMenu) => {
				...
				// show dropdown
				this._dropdown
					.attach(MdbBsDropdownContainerComponent)
					.to(this.container)
