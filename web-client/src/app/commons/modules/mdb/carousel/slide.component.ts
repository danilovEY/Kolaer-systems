...
export class MdbSlideComponent implements OnInit, OnDestroy {
	...
	protected carousel: MdbCarouselComponent;
	// public el: ElementRef = null;
	public el: ElementRef | any = null;

	public constructor(carousel: MdbCarouselComponent, el: ElementRef) {
