 ...
 */
@Entity
@Table(name = "db_holiday_report1", catalog = "kolaer_base", schema = "")
@XmlRootElement
public class DbHolidayReport1 implements Serializable {
    ...
    public DbHolidayReport1() {
    }

    public DbHolidayReport1(Integer id) {
        this.id = id;
    }

    public DbHolidayReport1(Integer id, String departamentAbbreviated, String post, String initials, short personNumber, int busyDay, Date dtHoliday, Date dtHolidayTo) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DbHolidayReport1)) {
            return false;
        }
        DbHolidayReport1 other = (DbHolidayReport1) object;
    ...
    public String toString() {
        return "ru.kolaer.server.dao.DbHolidayReport1[ id=" + id + " ]";
    }
