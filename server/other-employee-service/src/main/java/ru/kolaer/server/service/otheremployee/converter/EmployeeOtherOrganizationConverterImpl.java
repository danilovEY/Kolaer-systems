...
public class EmployeeOtherOrganizationConverterImpl implements EmployeeOtherOrganizationConverter {
    @Override
    public employee.EmployeeOtherOrganizationEntity convertToModel(EmployeeOtherOrganizationDto dto) {
        employee.EmployeeOtherOrganizationEntity employeeEntity = new employee.EmployeeOtherOrganizationEntity();
    ...
    @Override
    public EmployeeOtherOrganizationDto convertToDto(employee.EmployeeOtherOrganizationEntity model) {
