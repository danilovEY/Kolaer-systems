package ru.kolaer.server.webportal.microservice.holiday.service;
...
import ru.kolaer.server.webportal.microservice.holiday.converter.HolidayConverter;
import ru.kolaer.server.webportal.microservice.holiday.dto.FindHolidayRequest;
import ru.kolaer.server.webportal.microservice.holiday.dto.HolidayDto;
import ru.kolaer.server.webportal.microservice.holiday.entity.HolidayEntity;
import ru.kolaer.server.webportal.microservice.holiday.repository.HolidayRepository;
...
public class HolidayServiceImpl
        extends AbstractDefaultService<HolidayDto, HolidayEntity, HolidayRepository, HolidayConverter>
        implements HolidayService {

    protected HolidayServiceImpl(HolidayRepository defaultEntityDao, HolidayConverter converter) {
