...
export class MdbModalDirective implements AfterViewInit, OnDestroy {
	...
	@Output() public onShow: EventEmitter<MdbModalDirective> = new EventEmitter<MdbModalDirective>();
	/** This event is fired when the modal has been made visible to the user (will wait for CSS transitions to complete) */
	@Output() public onShown: EventEmitter<MdbModalDirective> = new EventEmitter<MdbModalDirective>();
	/** This event is fired immediately when the hide instance method has been called. */
	@Output() public onHide: EventEmitter<MdbModalDirective> = new EventEmitter<MdbModalDirective>();
	/** This event is fired when the modal has finished being hidden from the user (will wait for CSS transitions to complete). */
	@Output() public onHidden: EventEmitter<MdbModalDirective> = new EventEmitter<MdbModalDirective>();
	...
	protected backdrop: ComponentRef<MdbModalBackdropComponent>;
	private _backdrop: ComponentLoader<MdbModalBackdropComponent>;
	...
	public constructor(_element: ElementRef, _viewContainerRef: ViewContainerRef, _renderer: Renderer, clf: MdbComponentLoaderFactory) {
		this._element = _element;
		this._renderer = _renderer;
		this._backdrop = clf.createLoader<MdbModalBackdropComponent>(_element, _viewContainerRef, _renderer);
	}
