package ru.kolaer.server.service.kolpass.controller;
...
import ru.kolaer.server.service.kolpass.service.PasswordRepositoryService;
 ...
 */
@RestController
@RequestMapping(value = "/ru/kolaer/server/service/kolpass")
