package ru.kolaer.server.webportal.microservice.queue.repository;
...
import ru.kolaer.server.webportal.microservice.queue.dto.QueueSortType;
...
@Repository
@Slf4j
public class QueueRepositoryImpl extends AbstractDefaultRepository<QueueTargetEntity> implements QueueRepository {

    @Autowired
    public QueueRepositoryImpl(SessionFactory sessionFactory) {
