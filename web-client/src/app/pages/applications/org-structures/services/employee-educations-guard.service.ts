...
@Injectable()
export class EmployeeEducationsGuardService implements CanActivate {
    ...
    canActivate(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<boolean> | Promise<boolean> | boolean {
       return this._accountService.getCurrentAccount(false)
            .pipe(
                map((account: SimpleAccountModel) => account.access.includes(RoleConstant.EMPLOYEE_EDUCATIONS_READ) ||
