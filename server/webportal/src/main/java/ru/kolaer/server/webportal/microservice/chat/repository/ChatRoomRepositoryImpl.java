 ...
 */
@Repository
public class ChatRoomRepositoryImpl extends AbstractDefaultRepository<ChatRoomEntity> implements ChatRoomRepository {
    protected ChatRoomRepositoryImpl(SessionFactory sessionFactory) {
