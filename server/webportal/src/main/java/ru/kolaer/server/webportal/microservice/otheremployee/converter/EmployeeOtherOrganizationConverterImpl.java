...
public class EmployeeOtherOrganizationConverterImpl implements EmployeeOtherOrganizationConverter {
    @Override
    public ru.kolaer.server.webportal.microservice.employee.EmployeeOtherOrganizationEntity convertToModel(EmployeeOtherOrganizationDto dto) {
        ru.kolaer.server.webportal.microservice.employee.EmployeeOtherOrganizationEntity employeeEntity = new ru.kolaer.server.webportal.microservice.employee.EmployeeOtherOrganizationEntity();
    ...
    @Override
    public EmployeeOtherOrganizationDto convertToDto(ru.kolaer.server.webportal.microservice.employee.EmployeeOtherOrganizationEntity model) {
