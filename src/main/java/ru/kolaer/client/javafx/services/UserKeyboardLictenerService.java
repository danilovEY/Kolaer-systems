...
public class UserKeyboardLictenerService implements LocaleService {
         ...
         while (listen) {
             while (User32.PeekMessage(msg, null, 0,0, User32.PM_REMOVE)) {
                 if (msg.message == User32.WM_HOTKEY) {
                    ...
                    restTemplate.postForObject(Resources.URL_TO_KOLAER_RESTFUL.toString()+"system/user/"+username+"/key", key, String.class);
