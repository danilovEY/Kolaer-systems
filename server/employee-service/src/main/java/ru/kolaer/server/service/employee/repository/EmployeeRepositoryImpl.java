...
import ru.kolaer.server.service.employee.dto.CountEmployeeInDepartmentDto;
import ru.kolaer.server.service.employee.dto.EmployeeSortType;
import ru.kolaer.server.service.employee.dto.FindEmployeeByDepartment;
import ru.kolaer.server.service.employee.dto.FindEmployeePageRequest;
...
@Repository
@Slf4j
public class EmployeeRepositoryImpl extends AbstractDefaultRepository<EmployeeEntity> implements EmployeeRepository {

    protected EmployeeRepositoryImpl(SessionFactory sessionFactory) {
