...
export class MdbCarouselComponent implements OnDestroy {
	SWIPE_ACTION = {LEFT: 'swipeleft', RIGHT: 'swiperight'};

	protected _slides: LinkedList<MdbSlideComponent> = new LinkedList<MdbSlideComponent>();
	public get slides(): MdbSlideComponent[] {
	...
	public constructor(config: MdbCarouselConfig, el: ElementRef) {
	 ...
	 * @param slide
	 */
	public addSlide(slide: MdbSlideComponent): void {
	 ...
	 * @param slide
	 */
	public removeSlide(slide: MdbSlideComponent): void {
	...
	public getCurrentSlideIndex(): number {
		return this._slides.findIndex((slide: MdbSlideComponent) => slide.active);
	}
