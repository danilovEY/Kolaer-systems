...
import ru.kolaer.common.mvp.model.kolaerweb.kolchat.*;
...
import ru.kolaer.server.webportal.microservice.chat.ChatRoomService;
import ru.kolaer.server.webportal.microservice.chat.ChatRoomConverter;
import ru.kolaer.server.webportal.microservice.account.repository.AccountRepository;
import ru.kolaer.server.webportal.microservice.chat.ChatMessageRepository;
import ru.kolaer.server.webportal.microservice.chat.ChatRoomRepository;
import ru.kolaer.server.webportal.microservice.chat.ChatMessageEntity;
import ru.kolaer.server.webportal.microservice.chat.ChatRoomEntity;
...
@Service
@Slf4j
public class ChatRoomServiceImpl extends AbstractDefaultService<ChatRoomDto, ChatRoomEntity, ChatRoomRepository, ChatRoomConverter>
    ...
    public ChatRoomServiceImpl(@Value("${secret_key:secret_key}") String key,
                               ...
                               ChatRoomRepository defaultEntityDao,
