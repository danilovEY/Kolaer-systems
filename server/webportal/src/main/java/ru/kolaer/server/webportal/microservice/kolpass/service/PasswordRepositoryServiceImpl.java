...
import ru.kolaer.server.webportal.microservice.kolpass.converter.PasswordHistoryConverter;
import ru.kolaer.server.webportal.microservice.kolpass.converter.PasswordRepositoryConverter;
import ru.kolaer.server.webportal.microservice.kolpass.entity.PasswordHistoryEntity;
import ru.kolaer.server.webportal.microservice.kolpass.entity.PasswordRepositoryEntity;
import ru.kolaer.server.webportal.microservice.kolpass.repository.PasswordHistoryRepository;
import ru.kolaer.server.webportal.microservice.kolpass.repository.PasswordRepositoryRepository;
