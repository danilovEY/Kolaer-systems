 ...
 */
@MappedSuperclass
@Table(name = "db_holiday", catalog = "kolaer_base", schema = "")
@XmlRootElement
public class DbHoliday implements Serializable {
    ...
    public DbHoliday(Short personNumber) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DbHoliday)) {
            return false;
        }
        DbHoliday other = (DbHoliday) object;
    ...
    public String toString() {
        return "ru.kolaer.server.dao.DbHoliday[ personNumber=" + personNumber + " ]";
    }
