package ru.kolaer.server.service.queue.controller;
...
import ru.kolaer.server.service.queue.service.QueueService;

@RestController
@RequestMapping(value = "/ru/kolaer/server/service/queue")
@Api(tags = "Очередь")
@Slf4j
