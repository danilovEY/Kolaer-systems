...
import ru.kolaer.server.webportal.microservice.account.converter.UrlSecurityConverter;
import ru.kolaer.server.webportal.microservice.account.repository.UrlSecurityRepository;
...
@Service
@Slf4j
public class UrlSecurityServiceImpl extends AbstractDefaultService<UrlSecurityDto, UrlSecurityEntity, UrlSecurityRepository, UrlSecurityConverter>
        implements UrlSecurityService {

    @Autowired
    public UrlSecurityServiceImpl(UrlSecurityRepository urlSecurityDao, UrlSecurityConverter converter) {
