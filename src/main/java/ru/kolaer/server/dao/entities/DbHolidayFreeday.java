 ...
 */
@MappedSuperclass
@Table(name = "db_holiday_freeday", catalog = "kolaer_base", schema = "")
@XmlRootElement
public class DbHolidayFreeday implements Serializable {
    ...
    public DbHolidayFreeday() {
    }

    public DbHolidayFreeday(Short personNumber) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DbHolidayFreeday)) {
            return false;
        }
        DbHolidayFreeday other = (DbHolidayFreeday) object;
    ...
    public String toString() {
        return "ru.kolaer.server.dao.DbHolidayFreeday[ personNumber=" + personNumber + " ]";
    }
