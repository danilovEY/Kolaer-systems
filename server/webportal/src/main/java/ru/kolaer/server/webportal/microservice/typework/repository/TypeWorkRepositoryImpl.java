...
import ru.kolaer.server.webportal.microservice.typework.dto.TypeWorkSortType;
...
@Repository
public class TypeWorkRepositoryImpl extends AbstractDefaultRepository<TypeWorkEntity> implements TypeWorkRepository {

    public TypeWorkRepositoryImpl(SessionFactory sessionFactory) {
