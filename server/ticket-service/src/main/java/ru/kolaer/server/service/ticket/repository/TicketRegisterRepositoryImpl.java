 ...
 */
@Repository
public class TicketRegisterRepositoryImpl extends AbstractDefaultRepository<TicketRegisterEntity> implements TicketRegisterRepository {

    protected TicketRegisterRepositoryImpl(SessionFactory sessionFactory) {
