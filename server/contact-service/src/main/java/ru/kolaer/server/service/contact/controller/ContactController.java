package ru.kolaer.server.service.contact.controller;
...
import ru.kolaer.server.service.contact.service.ContactService;
...
public class ContactController {
    ...
    @RequestMapping(value = "/ru/kolaer/server/service/contact/employee/{employeeId}", method = RequestMethod.PUT, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
