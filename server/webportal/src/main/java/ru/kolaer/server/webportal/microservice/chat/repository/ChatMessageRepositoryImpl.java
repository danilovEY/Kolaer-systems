package ru.kolaer.server.webportal.microservice.chat.repository;
 ...
 */
@Repository
public class ChatMessageRepositoryImpl extends AbstractDefaultRepository<ChatMessageEntity> implements ChatMessageRepository {
    protected ChatMessageRepositoryImpl(SessionFactory sessionFactory) {
