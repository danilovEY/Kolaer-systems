package ru.kolaer.server.service.placement.controller;
...
import ru.kolaer.server.service.placement.service.PlacementService;
import ru.kolaer.server.webportal.annotations.UrlDeclaration;
import ru.kolaer.server.service.placement.dto.PlacementDto;
import ru.kolaer.server.service.placement.dto.PlacementFilter;
import ru.kolaer.server.service.placement.dto.PlacementSort;


@Api(tags = "Помещения")
@RestController
@RequestMapping(value = "/ru/kolaer/server/service/placement")
