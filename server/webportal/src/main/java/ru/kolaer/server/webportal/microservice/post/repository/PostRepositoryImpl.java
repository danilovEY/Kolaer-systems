 ...
 */
@Repository
public class PostRepositoryImpl extends AbstractDefaultRepository<PostEntity> implements PostRepository {
    protected PostRepositoryImpl(SessionFactory sessionFactory) {
