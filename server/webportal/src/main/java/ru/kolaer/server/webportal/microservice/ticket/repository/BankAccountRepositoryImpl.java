 ...
 */
@Repository
public class BankAccountRepositoryImpl extends AbstractDefaultRepository<BankAccountEntity> implements BankAccountRepository {

    protected BankAccountRepositoryImpl(SessionFactory sessionFactory) {
